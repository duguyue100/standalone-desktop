...
use crate::cli::sqlite_migration::SqliteMigrationProgress;
use crate::constants::*;
...
async fn initialize(app: AppHandle) {
    ...
    // Spawn opencode from PATH - credentials are known before health check
...
async fn run_loading_sequence(
    app: &AppHandle,
    init_tx: watch::Sender<InitStep>,
    ...
    let pending = loading_task.clone();
