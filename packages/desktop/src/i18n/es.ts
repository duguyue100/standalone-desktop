export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de AlfAlfa",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de AlfAlfa. ¿Quieres instalarla y reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentación de AlfAlfa",
  ...
  "desktop.cli.error.sidecarMissing":
    "Falta el binario de la CLI de AlfAlfa. Intenta reinstalar la aplicación de escritorio.",
