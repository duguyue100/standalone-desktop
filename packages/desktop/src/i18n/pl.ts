export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji AlfAlfa",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} AlfAlfa. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.menu.help.documentation": "Dokumentacja AlfAlfa",
  ...
  "desktop.cli.error.sidecarMissing":
    "Brakuje pliku binarnego AlfAlfa CLI. Spróbuj ponownie zainstalować aplikację na komputer.",
