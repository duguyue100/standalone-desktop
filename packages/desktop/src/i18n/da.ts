export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af AlfAlfa",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af AlfAlfa er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.menu.help.documentation": "AlfAlfa Dokumentation",
  ...
  "desktop.cli.error.sidecarMissing": "AlfAlfa CLI-binærfil mangler. Prøv at geninstallere desktop-appen.",
