export const dict = {
  ...
  "desktop.updater.none.message": "你已在使用最新版的 AlfAlfa",
  ...
  "desktop.updater.downloaded.prompt": "已下載 AlfAlfa {{version}} 版本，是否安裝並重新啟動？",
  ...
  "desktop.menu.help.documentation": "AlfAlfa 文件",
  ...
  "desktop.cli.error.sidecarMissing": "AlfAlfa CLI 執行檔遺失。請嘗試重新安裝桌面應用程式。",
