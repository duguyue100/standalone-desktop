export const dict = {
  ...
  "desktop.updater.none.message": "이미 최신 버전의 AlfAlfa를 사용하고 있습니다",
  ...
  "desktop.updater.downloaded.prompt": "AlfAlfa {{version}} 버전을 다운로드했습니다. 설치하고 다시 실행할까요?",
  ...
  "desktop.menu.help.documentation": "AlfAlfa 문서",
  ...
  "desktop.cli.error.sidecarMissing": "AlfAlfa CLI 바이너리가 누락되었습니다. 데스크톱 앱을 다시 설치해 보세요.",
