export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av AlfAlfa",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av AlfAlfa er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.menu.help.documentation": "AlfAlfa Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "AlfAlfa CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
