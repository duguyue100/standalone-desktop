export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von AlfAlfa",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von AlfAlfa wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.cli.error.sidecarMissing":
    "Das AlfAlfa CLI-Binary fehlt. Versuchen Sie, die Desktop-App neu zu installieren.",
