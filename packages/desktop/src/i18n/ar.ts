export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من AlfAlfa",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من AlfAlfa، هل ترغب في تثبيته وإعادة تشغيله؟",
  ...
  "desktop.menu.help.documentation": "وثائق AlfAlfa",
  ...
  "desktop.cli.error.sidecarMissing": "ملف AlfAlfa CLI الثنائي مفقود. حاول إعادة تثبيت تطبيق سطح المكتب.",
