export const dict = {
  ...
  "desktop.menu.help.documentation": "AlfAlfa Documentation",
  ...
  "desktop.updater.none.message": "You are already using the latest version of AlfAlfa",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of AlfAlfa has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.error.sidecarMissing": "AlfAlfa CLI binary is missing. Try reinstalling the desktop app.",
