export const dict = {
  ...
  "desktop.updater.none.message": "Вы уже используете последнюю версию AlfAlfa",
  ...
  "desktop.updater.downloaded.prompt": "Версия AlfAlfa {{version}} загружена. Хотите установить и перезапустить?",
  ...
  "desktop.menu.help.documentation": "Документация AlfAlfa",
  ...
  "desktop.cli.error.sidecarMissing":
    "Отсутствует бинарный файл AlfAlfa CLI. Попробуйте переустановить настольное приложение.",
