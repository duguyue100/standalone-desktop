export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju AlfAlfa-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} AlfAlfa-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
  ...
  "desktop.menu.help.documentation": "AlfAlfa Dokumentacija",
  ...
  "desktop.cli.error.sidecarMissing":
    "Nedostaje binarna datoteka AlfAlfa CLI-a. Pokušaj ponovo instalirati desktop aplikaciju.",
