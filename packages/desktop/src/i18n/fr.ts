export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'AlfAlfa",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'AlfAlfa a été téléchargée. Voulez-vous l'installer et redémarrer ?",
  ...
  "desktop.menu.help.documentation": "Documentation d'AlfAlfa",
  ...
  "desktop.cli.error.sidecarMissing":
    "Le binaire de la CLI AlfAlfa est manquant. Essayez de réinstaller l'application de bureau.",
