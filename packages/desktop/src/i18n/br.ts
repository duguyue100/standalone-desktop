export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do AlfAlfa",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do AlfAlfa foi baixada. Você gostaria de instalá-la e reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentação do AlfAlfa",
  ...
  "desktop.cli.error.sidecarMissing":
    "O binário da CLI do AlfAlfa está ausente. Tente reinstalar o aplicativo de desktop.",
