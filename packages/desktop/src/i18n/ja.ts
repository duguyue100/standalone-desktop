export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの AlfAlfa を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "AlfAlfa のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.menu.help.documentation": "AlfAlfa ドキュメント",
  ...
  "desktop.cli.error.sidecarMissing":
    "AlfAlfa CLI のバイナリが見つかりません。デスクトップアプリを再インストールしてみてください。",
